...
private void consultarAluno() {
    ...
    // Minimal local stubs so this view compiles without external project classes.
    // Replace these with your real implementations from your project.
    private static class AlunoDao { }

    private static class ProfessorDao { }

    private static class AlunoController {
    ...
    private static class ProfessorController {
